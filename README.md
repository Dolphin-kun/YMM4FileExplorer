...
## 更新履歴
 	2025/11/17
		v1.5.3 修正
			- ListItemを右クリックするとエラーが発生する問題を修正。
			- アクセス不可能なフォルダにアクセスできないように。
 	2025/10/05
		v1.5.2 修正/変更
			- gifを動画として再生できるように修正。
			- 空白の右クリックもしくはホイール押し込みでホームに戻る機能の追加。
			- ToolTipの表示。
			- ニコニコモンズのIDを追加。
 	2025/09/13
		v1.5.1 修正
 	...
 	2025/09/13
		v1.5.0 追加
			- 大きく表示機能の追加。
			- 動画ファイルのプレビューにスライダーを追加。
 	2025/09/10
		v1.4.0 追加
			- サムネイル表示の選択肢を追加。
			- お気に入り機能の追加。
			- フォルダ選択時に表示を移動する設定を追加。
 	2025/09/02
		v1.3.1 修正/変更
			- ゆっくりMovieMaker4.45.0.0に対応。
			- パスで検索できるように変更。
	2025/08/10
		v1.3.0 修正/変更
			- フォルダの階層が維持されない問題を修正。
